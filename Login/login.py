...
class Login():
	...
	def username_list(self):
		...
		if inputmethod.lower() == 'cli':
			...
			print('Reading data from "username.yaml" file')
			with open('input/username.yaml') as f:
	...
	def password_list(self):
		...
		if inputmethod.lower() == 'cli':
			...
			print('Reading data from "password.yaml" file')
			with open('input/password.yaml') as f:
	...
	def enable_list(self):
		...
		if inputmethod.lower() == 'cli':
			...
			print('Reading data from "enablepassword.yaml" file')
			with open('input/enablepassword.yaml') as f:
				enablelist = yaml.safe_load(f)
	...
	def main(self):
		...
		#reading passwords
		passwordlist = self.password_list()
